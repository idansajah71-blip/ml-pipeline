...
async def discover_models(
    ...
    {
        "id": "platform-24",
        "model_name": "Prediksi Suhu Harian Kota",
        "category": "prediksi-harga",
        "use_case": "Estimasi suhu udara harian berdasarkan lokasi, musim, dan data historis cuaca",
        "description": "Untuk BMKG dan aplikasi cuaca. Bantu perencanaan aktivitas luar ruangan dan pertanian.",
        "tags": ["cuaca", "suhu", "regresi", "iklim"],
        "feature_names": ["suhu_kemarin", "kelembaban_persen", "curah_hujan_mm", "kecepatan_angin_kmh", "ketinggian_mdpl", "bulan", "lintang_bujur"],
        "target_column": "suhu_max_celsius",
        "algorithm": "gradient_boosting",
        "metrics": {"r2": 0.91, "mae": 1.2, "rmse": 1.8},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 423, "rating": 4.5, "rating_count": 34,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Suhu Maksimum", "result_unit": "Celsius", "result_type": "regression",
    },
    {
        "id": "platform-25",
        "model_name": "Klasifikasi Jenis Kelamin dari Foto",
        "category": "klasifikasi-kualitas",
        "use_case": "Identifikasi jenis kelamin dari foto wajah untuk analitik demografi",
        "description": "Model computer vision untuk retail analytics dan crowd monitoring.",
        "tags": ["cv", "wajah", "klasifikasi", "demografi"],
        "feature_names": ["rasio_lebar_tinggi_wajah", "posisi_alis", "bentuk_rahang", "panjang_rambut", "textur_kulit", "sudut_dahi", "proporsi_mata"],
        "target_column": "jenis_kelamin",
        "algorithm": "cnn",
        "metrics": {"accuracy": 0.93, "f1": 0.92, "precision": 0.93, "recall": 0.91},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 567, "rating": 4.4, "rating_count": 42,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Prediksi", "result_unit": None, "result_type": "classification",
        "class_labels": {"0": "Laki-laki", "1": "Perempuan"},
    },
    {
        "id": "platform-26",
        "model_name": "Prediksi Omset UMKM Bulanan",
        "category": "prediksi-harga",
        "use_case": "Estimasi omset bulanan UMKM berdasarkan jenis usaha, lokasi, dan tren pasar",
        "description": "Untuk pelaku UMKM dan pemberi pinjaman. Perencanaan keuangan dan asesmen risiko.",
        "tags": ["umkm", "omset", "regresi", "bisnis"],
        "feature_names": ["jenis_usaha", "jumlah_karyawan", "luas_toko_m2", "harga_sewa_bulan", "traffic_kaki", "hari_operasi", "tren_lokasi"],
        "target_column": "omset_bulan_juta",
        "algorithm": "gradient_boosting",
        "metrics": {"r2": 0.84, "mae": 8.7, "rmse": 13.5},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 389, "rating": 4.3, "rating_count": 28,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Estimasi Omset", "result_unit": "Juta Rupiah", "result_type": "regression",
    },
    {
        "id": "platform-27",
        "model_name": "Deteksi Kualitas Air Minum",
        "category": "deteksi-anomali",
        "use_case": "Prediksi apakah air minum layak konsumsi berdasarkan parameter kimiawi",
        "description": "Model untuk PDAM dan industri makanan. Pastikan kualitas air sesuai standar.",
        "tags": ["air", "kualitas", "klasifikasi", "kesehatan"],
        "feature_names": ["ph", "turbidity_ntu", "tds_ppm", "suhu_celsius", "klorin_mg_l", "bakteri_coliform", "logam_berat_ppm"],
        "target_column": "layak_konsumsi",
        "algorithm": "random_forest",
        "metrics": {"accuracy": 0.95, "f1": 0.94, "precision": 0.96, "recall": 0.92},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 312, "rating": 4.7, "rating_count": 21,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Status Air", "result_unit": None, "result_type": "classification",
        "class_labels": {"0": "Tidak Layak", "1": "Layak Konsumsi"},
    },
    {
        "id": "platform-28",
        "model_name": "Prediksi Harga Emas Harian",
        "category": "prediksi-harga",
        "use_case": "Estimasi harga emas (antam) berdasarkan tren pasar, dollar, dan inflasi",
        "description": "Untuk investor dan penjual emas. Prediksi fluktuasi harga emas harian.",
        "tags": ["emas", "investasi", "regresi", "keuangan"],
        "feature_names": ["harga_kemarin", "nilai_tukar_usd", "inflasi_bulanan", "suku_bunga", "harga_minyak", "indeks_saham", "volume_perdagangan"],
        "target_column": "harga_emas_per_gram",
        "algorithm": "lstm",
        "metrics": {"r2": 0.88, "mae": 15200, "rmse": 23400},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 876, "rating": 4.6, "rating_count": 67,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Harga Emas", "result_unit": "Rupiah/gram", "result_type": "regression",
    },
    {
        "id": "platform-29",
        "model_name": "Klasifikasi Tingkat Keparahan Pneumonia",
        "category": "klasifikasi-kualitas",
        "use_case": "Prediksi tingkat keparahan pneumonia dari foto X-ray paru-paru",
        "description": "Model computer vision untuk rumah sakit. Bantu dokter prioritas pasien kritis.",
        "tags": ["medis", "x-ray", "klasifikasi", "paru-paru"],
        "feature_names": ["area_opacitas_persen", "lokasi_lesi", "simetri_paru", "kontras_gambar", "tekstur_jaringan", "batas_cabang", "intensitas_pixel"],
        "target_column": "tingkat_keparahan",
        "algorithm": "cnn",
        "metrics": {"accuracy": 0.91, "f1": 0.89, "precision": 0.92, "recall": 0.88},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 445, "rating": 4.8, "rating_count": 35,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Tingkat Keparahan", "result_unit": None, "result_type": "classification",
        "class_labels": {"0": "Normal", "1": "Ringan", "2": "Sedang", "3": "Berat"},
    },
    {
        "id": "platform-30",
        "model_name": "Prediksi Biaya Kursus Online",
        "category": "prediksi-harga",
        "use_case": "Estimasi biaya kursus online berdasarkan topik, durasi, dan reputasi instruktur",
        "description": "Untuk platform edukasi dan instruktur. Pricing strategi kursus online.",
        "tags": ["edukasi", "kursus", "regresi", "online"],
        "feature_names": ["topik_kursus", "durasi_jam", "jumlah_modul", "rating_instruktur", "jumlah_siswa", "sertifikat", "platform_hosting"],
        "target_column": "biaya_kursus_ribu",
        "algorithm": "random_forest",
        "metrics": {"r2": 0.81, "mae": 45.2, "rmse": 78.3},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 234, "rating": 4.1, "rating_count": 16,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Estimasi Biaya", "result_unit": "Ribu Rupiah", "result_type": "regression",
    },
    {
        "id": "platform-31",
        "model_name": "Deteksi Bot/Mediator Sosial Media",
        "category": "deteksi-anomali",
        "use_case": "Identifikasi akun bot di media sosial berdasarkan pola aktivitas dan konten",
        "description": "Untuk brand dan platform sosial media. Jaga integritas data engagement.",
        "tags": ["sosial media", "bot", "klasifikasi", "cyber"],
        "feature_names": ["frekuensi_posting", "waktu_aktif_reguler", "rasio_following_followers", "panjang_komentar_rata", "ada_link_spam", "usia_akun_hari", "variasi_waktu_posting"],
        "target_column": "adalah_bot",
        "algorithm": "xgboost",
        "metrics": {"accuracy": 0.94, "f1": 0.92, "precision": 0.95, "recall": 0.90},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 356, "rating": 4.5, "rating_count": 27,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Status Akun", "result_unit": None, "result_type": "classification",
        "class_labels": {"0": "Akun Manusia", "1": "BOT"},
    },
    {
        "id": "platform-32",
        "model_name": "Prediksi Kebutuhan Stok Gudang",
        "category": "prediksi-harga",
        "use_case": "Forecast kebutuhan stok gudang berdasarkan tren penjualan dan musiman",
        "description": "Untuk warehouse dan supply chain. Optimasi stok dan kurangi overstock.",
        "tags": ["gudang", "stok", "regresi", "supply chain"],
        "feature_names": ["penjualan_30_hari", "tren_penjualan", "hari_libur_mendatang", "musim", "jumlah_sku", "lead_time_hari", "promo_mendatang"],
        "target_column": "kebutuhan_stok_unit",
        "algorithm": "gradient_boosting",
        "metrics": {"r2": 0.86, "mae": 52.3, "rmse": 89.1},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 298, "rating": 4.4, "rating_count": 23,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Kebutuhan Stok", "result_unit": "Unit", "result_type": "regression",
    },
    {
        "id": "platform-33",
        "model_name": "Klasifikasi Kualitas Teh Hijau",
        "category": "klasifikasi-kualitas",
        "use_case": "Penetapan grade kualitas teh hijau (A/B/C) berdasarkan warna, aroma, dan bentuk daun",
        "description": "Untuk pabrik teh dan eksportur. Standarisasi kualitas otomatis.",
        "tags": ["teh", "kualitas", "klasifikasi", "agrikultur"],
        "feature_names": ["warna_daun_nilai", "aroma_intensitas", "bentuk_daun", "ukuran_daun_mm", "kelembaban_persen", "kadar_kafein", "tahun_panen"],
        "target_column": "grade_teh",
        "algorithm": "random_forest",
        "metrics": {"accuracy": 0.89, "f1": 0.87, "precision": 0.90, "recall": 0.85},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 189, "rating": 4.3, "rating_count": 14,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Grade Teh", "result_unit": None, "result_type": "classification",
        "class_labels": {"0": "Grade C", "1": "Grade B", "2": "Grade A (Premium)"},
    },
    {
        "id": "platform-34",
        "model_name": "Prediksi Retensi Pelanggan",
        "category": "prediksi-harga",
        "use_case": "Estimasi berapa lama pelanggan akan tetap aktif (dalam bulan) berdasarkan perilaku",
        "description": "Untuk SaaS dan subscription business. Prediksi customer lifetime value.",
        "tags": ["retensi", "pelanggan", "regresi", "SaaS"],
        "feature_names": ["frekuensi_login_mingguan", "fitur_digunakan", "lama_bergabung_bulan", "tagihan_bulanan", "jumlah_support_ticket", "nps_score", "referensi_dibuat"],
        "target_column": "masa_aktif_bulan",
        "algorithm": "gradient_boosting",
        "metrics": {"r2": 0.82, "mae": 3.4, "rmse": 5.8},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 412, "rating": 4.5, "rating_count": 31,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Perkiraan Retensi", "result_unit": "Bulan", "result_type": "regression",
    },
    {
        "id": "platform-35",
        "model_name": "Klasifikasi Jenis Kanker dari Lab",
        "category": "deteksi-anomali",
        "use_case": "Identifikasi jenis kanker berdasarkan data laboratorium darah dan urin",
        "description": "Model skrining untuk rumah sakit. Deteksi dini mempercepat penanganan.",
        "tags": ["medis", "kanker", "klasifikasi", "laboratorium"],
        "feature_names": ["ca_125", "cea", "psa", "hemoglobin", "leukosit", "trombosit", "kreatinin", "sgot_sgot_rasio"],
        "target_column": "jenis_kanker",
        "algorithm": "xgboost",
        "metrics": {"accuracy": 0.90, "f1": 0.88, "precision": 0.91, "recall": 0.86},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 523, "rating": 4.7, "rating_count": 38,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Skrining Kanker", "result_unit": None, "result_type": "classification",
        "class_labels": {"0": "Tidak Ada Indikasi", "1": "Serviks", "2": "Kolorektal", "3": "Prostat"},
    },
    {
        "id": "platform-36",
        "model_name": "Prediksi Jumlah Tamu Hotel",
        "category": "prediksi-harga",
        "use_case": "Forecast jumlah tamu hotel harian berdasarkan musim, event, dan tren booking",
        "description": "Untuk hotel dan travel agent. Optimasi kamar, staf, dan harga.",
        "tags": ["hotel", "pariwisata", "regresi", "booking"],
        "feature_names": ["bulan", "hari_dalam_minggu", "booking_online", "event_lokasi", "cuaca_prediksi", "harga_kamar_rata", "tren_liburan"],
        "target_column": "jumlah_tamu",
        "algorithm": "gradient_boosting",
        "metrics": {"r2": 0.85, "mae": 18.7, "rmse": 31.2},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 345, "rating": 4.3, "rating_count": 25,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Perkiraan Tamu", "result_unit": "Orang", "result_type": "regression",
    },
    {
        "id": "platform-37",
        "model_name": "Klasifikasi Tingkat Kepuasan Restoran",
        "category": "deteksi-churn",
        "use_case": "Prediksi kepuasan pelanggan restoran dari data pesanan dan ulasan",
        "description": "Untuk F&B owner. Monitoring kualitas layanan secara real-time.",
        "tags": ["restoran", "ulasan", "klasifikasi", "F&B"],
        "feature_names": ["waktu_tunggu_menit", "akurasi_pesanan", "suhu_makanan", "rating_layanan", "jumlah_komplain", "repeat_order", "total_belanja"],
        "target_column": "tingkat_kepuasan",
        "algorithm": "logistic_regression",
        "metrics": {"accuracy": 0.87, "f1": 0.85, "precision": 0.88, "recall": 0.83},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 267, "rating": 4.2, "rating_count": 19,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Kepuasan", "result_unit": None, "result_type": "classification",
        "class_labels": {"0": "Tidak Puas", "1": "Cukup", "2": "Puas", "3": "Sangat Puas"},
    },
    {
        "id": "platform-38",
        "model_name": "Prediksi Curah Hujan Bulanan",
        "category": "prediksi-harga",
        "use_case": "Estimasi curah hujan bulanan berdasarkan data historis dan fenomena alam",
        "description": "Untuk Dinas Pertanian dan Pengelola SDA. Perencanaan irigasi dan mitigasi banjir.",
        "tags": ["cuaca", "hujan", "regresi", "hidrologi"],
        "feature_names": ["curah_hujan_bulan_lalu", "suhu_permukaan_laut", "kelembaban_relatif", "tekanan_udara", "angin_monsum", "el_nino_index", "bulan"],
        "target_column": "curah_hujan_mm",
        "algorithm": "random_forest",
        "metrics": {"r2": 0.83, "mae": 42.5, "rmse": 68.3},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 378, "rating": 4.4, "rating_count": 29,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Curah Hujan", "result_unit": "mm", "result_type": "regression",
    },
    {
        "id": "platform-39",
        "model_name": "Klasifikasi Status Gizi Balita",
        "category": "klasifikasi-kualitas",
        "use_case": "Prediksi status gizi balita (stunting/normal/obesitas) dari data antropometri",
        "description": "Untuk posyandu dan dinas kesehatan. Deteksi dini masalah gizi anak.",
        "tags": ["kesehatan", "gizi", "klasifikasi", "balita"],
        "feature_names": ["tinggi_badan_cm", "berat_badan_kg", "umur_bulan", "lingkar_lengan", "lingkar_kepala", "imunisasi_lengkap", "asi_eksklusif"],
        "target_column": "status_gizi",
        "algorithm": "random_forest",
        "metrics": {"accuracy": 0.92, "f1": 0.90, "precision": 0.93, "recall": 0.89},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 456, "rating": 4.8, "rating_count": 37,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Status Gizi", "result_unit": None, "result_type": "classification",
        "class_labels": {"0": "Stunting", "1": "Normal", "2": "Gizi Lebih"},
    },
    {
        "id": "platform-40",
        "model_name": "Prediksi Pendapatan Content Creator",
        "category": "prediksi-harga",
        "use_case": "Estimasi pendapatan bulanan content creator dari subscriber, views, dan engagement",
        "description": "Untuk creator dan agensi. Perencanaan monetisasi dan benchmarking.",
        "tags": ["creator", "youtube", "regresi", "monetisasi"],
        "feature_names": ["jumlah_subscriber", "views_per_video", "engagement_rate", "frekuensi_upload", "durasi_rata_video", "topik_konten", "jumlah_kolaborasi"],
        "target_column": "pendapatan_bulan_juta",
        "algorithm": "gradient_boosting",
        "metrics": {"r2": 0.80, "mae": 5.8, "rmse": 9.4},
        "is_public": 1, "shared_by": "platform", "permission": "read",
        "downloads": 623, "rating": 4.6, "rating_count": 48,
        "is_platform_model": True, "created_at": "2026-08-01T00:00:00",
        "result_label": "Estimasi Pendapatan", "result_unit": "Juta Rupiah", "result_type": "regression",
    },
